...
Item{
    ...
    anchors.right: if(currentSide===Prompt.Right)canvasCont.left
    anchors.left: if(currentSide===Prompt.Left)canvasCont.right
    anchors.horizontalCenter: if(currentSide===Prompt.Center)parent.horizontalCenter
    ...
    Item{
        ...
        anchors.right: if(currentSide===Prompt.Right)parent.right
        anchors.left: if(currentSide===Prompt.Left)parent.left
        Canvas {
            id: canvas
